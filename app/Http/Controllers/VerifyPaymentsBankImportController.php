        ...
        if ($mime == "text/plain") {
            ...
            while (!feof($arch)){
                ...
                if ($band==true) {
                    ...
                    $date = substr($otra, 11, 10) . "<br>";
                    $amountTotal = substr($otra, 21, 14) . "<br>";
                    $amountTotalTwo=str_replace(',','',$amountTotal);
                    $amountTotalThere=str_replace(',','.',$amountTotal);

                    echo substr($otra, 0, 1) . "<br>";
                    echo substr($otra, 1, 5) . "<br>";
                    echo substr($otra, 6, 5) . "<br>";
                    echo substr($otra, 11, 10) . "<br>";
                    echo $amountTotal."<br>";
                    ...
                    echo substr($otra, 0, 1) . "<br>";
                    echo substr($otra, 1, 10) . "<br>";
                    echo substr($otra, 11, 16) . "<br>";
                    echo $amountTwo . "<br>";
                    echo $amountThere . "<br>";
                    echo substr($otra, 41, 30) . "<br>";
                    echo substr($otra, 71, 10) . "<br>";
                }
                var_dump($otra);
