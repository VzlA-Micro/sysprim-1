            ...
            <div class="col s12 m8 offest-m2 l6 offset-l3">
                <form action="" method="post" class="card bg-light-opacity-8">
                    ...
                    <div class="card-content row">
                        @csrf
                        <div class="input-field col s2 tooltipped" data-position="left" data-tooltip="V: Venezolano; E: Extrangero">
                        ...
                        <div class="input-field col s10 m4 tooltipped" data-position="left" data-tooltip="Solo puede escribir números. Ej: 12345678">
                                <input id="ci" type="text" name="ci" class="validate" pattern="[0-9]+" title="Solo puede escribir números." required>
                                <label for="ci">Cedula</label>
                            </div>
                        <div class="input-field col s12 m6 tooltipped" data-position="left" data-tooltip="Solo puede agregar letras (con acentos).">
                        ...
                        <div class="input-field col s2 tooltipped" data-position="left" data-tooltip="+58 (VE)">
                        ...
                        <div class="input-field col s10 m4 tooltipped" data-position="left" data-tooltip="Solo puede escribir números">
                        ...
                        <div class="input-field col s12 tooltipped" data-position="left" data-tooltip="Ej: correo@mail.com">
                            <input id="email" type="email" name="email" class="validate" value="{{ old('email') }}" required>
                            <label for="email">E-mail</label>
                        </div>
                        <div class="input-field col s12 tooltipped" data-position="left" data-tooltip="Ej: Venezuela1234">
