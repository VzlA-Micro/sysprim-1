...
@php setlocale(LC_MONETARY, 'en_US');@endphp
    	...
    	<table style="width: 100%; border-collapse: collapse;">
	        <tr style="text-align: center">
	            <td style="width: 25%;" rowspan="2">
					<img src="http://sysprim.com.devel/images/alcaldia_logo.png" style="width:180px; height:80px" alt=""><br>
					<span></span><br>
    ...
    <table style="width: 100%; border-collapse: collapse;">
    	<tr style="">
    		...
    		<td style="width:35%;font-size: 11px !important;">{{$nameUser}}</td>
    		<td style="width:20%;font-size: 12px !important;"><b>Codigo Catastral:</b></td>
    		<td style="width:30%;font-size: 11px !important;">{{$cadastral}}</td>
    	</tr>
    	<tr>
    		<td style="width:15%;font-size: 12px !important;"><b>Cedula o RIF:</b></td>
    		<td style="width:35%;font-size: 11px !important;">{{$ci}}</td>

    	</tr>
    	<tr>
    		<td style="width:15%;font-size: 12px !important"><b>Dirección:</b></td>
    		<td style="width:35%;font-size: 11px !important">{{$property->address}}</td>
    	...
    	<tr>
    		...
    		<td style="width:35%;font-size: 11px !important;">{{$tel}}</td>
	...
	<table style="width: 100%;">
		...
		<tbody>
			...
			<tr>
				<td style="width: 10%;font-size: 10px !important;">{{$build}}</td>
				<td style="width: 30%;font-size: 10px;!important;">{{$taxes->branch}}</td>
				<td style="width: 10%;font-size: 10px;!important">{{\Carbon\Carbon::parse($taxes->fiscal_period)->format('Y')}}</td>
				<td style="width: 10%;font-size: 10px; !important;">{{$costBuild}}</td>
			...
			<tr>
				<td style="width: 10%;font-size: 10px !important;">{{$ground}}</td>
				<td style="width: 30%;font-size: 10px;!important;">{{$taxes->branch}}</td>
				<td style="width: 10%;font-size: 10px;!important">{{\Carbon\Carbon::parse($taxes->fiscal_period)->format('Y')}}</td>
				<td style="width: 10%;font-size: 10px; !important;">{{$costGround}}</td>
				<td style="width: 15%;font-size: 10px;!important"></td>
				<td style="width: 15%;font-size: 10px;!important"></td>
				<td style="width: 10%;font-size: 10px;!important"></td>
			</tr>
