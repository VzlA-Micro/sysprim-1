            ...
            <div class="col s12 m8 l8 offset-m3 offset-l2">
                <form action="{{ route('companies.update') }}" method="post" class="card" enctype="multipart/form-data">
                    <div class="card-header center-align">
                        <h5>Editar datos de mi Inmueble</h5>
                    </div>
                    ...
                    <div class="card-content row">
                        @csrf
                        <input type="hidden" name="id" name="id" value="{{ $property->id }}">
                        <div class="input-field col s12 m6 tooltipped" data-position="left" data-tooltip="Razón social o nombre de la empresa.">
                            ...
                            <input type="text" name="name" id="name" class="validate"  pattern="[0-9A-Za-zàáâäãèéêëìíîïòóôöõùúûüñçÀÁÂÄÃÈÉÊËÌÍÎÏÒÓÔÖÕÙÚÛÜÑßÇ .,!?_-&%+-$]+" title="Solo puede usar letras (con acentos), números y los caracteres especiales: . , $ ! ? % + -" value="{{ $property->codigo_catastral }}" required disabled>
                            <label for="name">Codigo Catastral</label>
                        </div>
