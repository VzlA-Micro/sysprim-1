...
@section('content')
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="card col s12 m8 l8 offset-m2 offset-l2">
                    ...
                    <div class="card-content row">
                        ...
                        <div class="row offset-2">
                            ...
                            <div class="">
                                <form action="#" method="post" id="verification" class="card"
                                      enctype="multipart/form-data">

                                    <div class="input-field col s10 m2 tooltipped" data-position="bottom"
                                    ...
                                    <div class="input-field col s10 m2 tooltipped" data-position="bottom"
                                         data-tooltip="Solo puede escribir números. Ej: 1234567890">
                                        <input type="text" name="C8" id="C8" class="validate" pattern="[0-9]+"
                                               maxlength="3" minlength="3" title="Solo puede escribir números."
                                               required>
                                    ...
                                    <div class="input-field col s10 m2 tooltipped" data-position="bottom"
                                         data-tooltip="Solo puede escribir números. Ej: 1234567890">
                                        <input type="text" name="C9" id="C9" class="validate" pattern="[0-9]+"
                                               maxlength="2" minlength="2" title="Solo puede escribir números."
                                               required>
                                        <label for="C9">Condicion</label>
                                    </div>
                                    <div class="input-field col s10 m3 tooltipped" data-position="bottom"
                                         data-tooltip="Solo puede escribir números. Ej: 1234567890">
                                        <input type="text" name="C10" id="C10" class="validate" pattern="[0-9]+"
                                               maxlength="3" minlength="3" title="Solo puede escribir números."
                                               required>
                                        <label for="C10">N° de Construccion</label>
                                    </div>
                                    <div class="col m">
                                        <button id="" type="submit"
                                                class="btn btn-rounded waves-effect waves-light green"><i
                                                    class="icon-search"></i>Verificar
                                        </button>
                                    </div>
                        ...
                        <form action="#" method="post" id="property" class="" enctype="multipart/form-data">
                            ...
                            <div class="input-field col s12 m6">
                                <input type="text" name="area" id="area" class="validate" pattern="[0-9.]+"
