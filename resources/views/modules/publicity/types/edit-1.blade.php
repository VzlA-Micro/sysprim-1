            	...
            	<form method="post" action="{{ route('publicity.save') }}" class="card" enctype="multipart/form-data" id="update">
            		...
            		<div class="card-content row">
	            		...
	            		<div class="col s12">
		        			...
		        			<input type="text" class="js-range-slider width" name="width" id="width" value="{{ $publicity->width }}" disabled="disabled">
		            	</div>
		            	<div class="col s12">
						...
						<div class="input-field col s12">
		                    <input type="text" name="quantity" id="quantity" class="validate number-only" value="{{ $publicity->quantity }}" disabled>
