		...
		<div class="row">
			<div class="col s12">
				<ul class="breadcrumb">
					...
					@if(session()->has('company'))
						<li class="breadcrumb-item"><a href="{{ route('publicity.register.create',['id' => 1, 'company_id' => session('company')->id]) }}">Publicidad eventual u ocasional</a></li>
					@else
						<li class="breadcrumb-item"><a href="{{ route('publicity.register.create',['id' => 1]) }}">Publicidad eventual u ocasional</a></li>
					@endif
				</ul>
			</div>
					...
					<div id="property-tab">
						...
						<div class="card-content row">
							...
							<div class="input-field col s12">
								...
								<input type="number" name="quantity" id="quantity" minlength="1" required>
