        ...
        <div class="row">
            <div class="col s12">
                <ul class="breadcrumb">
                    ...
                    @if(session()->has('company'))
                        <li class="breadcrumb-item"><a href="{{ route('publicity.register.create',['id' => 3, 'company_id' => session('company')->id]) }}">Publicidad por tiempo de duración</a></li>
                    @else
                        <li class="breadcrumb-item"><a href="{{ route('publicity.register.create',['id' => 3]) }}">Publicidad por tiempo de duración</a></li>
                    @endif
                </ul>
            </div>
