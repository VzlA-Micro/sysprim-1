    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col s6 m6 l4 animated bounceIn">
                <a href="{{ route('catastral-terreno.timeline.register') }}" class="btn-app white blue-grey-text">
            ...
            <div class="col s6 m6 l4 animated bounceIn">
                <a href="{{ route('catastral-terreno.timeline.read') }}" class="btn-app white blue-grey-text">
