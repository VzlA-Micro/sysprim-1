    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col s12 breadcrumb-nav left-align">
                ...
                <a href="" class="breadcrumb">Mi Vehiculos</a>
                <a href="" class="breadcrumb">Nombre del Vehicuklo</a>
                ...
                <div class="card">
                    ...
                    <form method="post" action="{{route('vehicles.taxes.save')}}" id='register-taxes' class="card-content row">
                        ...
                        <div class="input-field col s12 m6">
                            ...
                            <input type="text" name="type" id="type" class="code" value="{{$vehicle[0]->type->name}}"
                                   required readonly>
