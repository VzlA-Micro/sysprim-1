                            ...
                            @foreach($company->ciu as $ciu)
                                <div class="ciu-company">
                                    ...
                                    <div class="input-field col s12 m6">
                                        ...
                                        <input type="text"  name="deductions[]" id="deductions_{{$ciu->code}}" class="validate money_keyup deductions"  required>
                                    ...
                                    <div class="input-field col s12 m6">
                                        ...
                                        <input type="text"  name="withholding[]" id="withholdings_{{$ciu->code}}" class="validate money_keyup withholding"   required>
                                    ...
                                    <div class="input-field col s12 m6">
                                        ...
                                        <input type="text" name="fiscal_credits[]" id="fiscal_credits_{{$ciu->code}}" class="validate money_keyup credits_fiscal"   required>
