        ...
        <div class="row">
            <div class="col s12">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('payments.create',['company'=>session('company')->id,'type'=>'actuated']) }}">Pagar
							Impuestos</a></li>
							...
							<div class="row">
								...
								<div class="col s12 m4">
									...
									<label class="btn-radio grey" for="ppv" >
										<i class="">
											<img src="{{ asset('images/png/001-point-of-service.png') }}"  style="height: 64px!important;width: 64px!important;" alt="Image pago" width="100%" height="100%">
										</i>
								...
								<div class="col s12 m4">
									...
									<label class="btn-radio grey" for="ptb">
										<i class="">
											<img src="{{ asset('images/png/009-smartphone-1.png') }}" style="height: 64px!important;width: 64px!important;" alt="Image pago" width="100%" height="100%">
										</i>
								...
								<div class="col s12 m4">
									...
									<label class="btn-radio grey" for="ppb">
										<i class="">
											<img src="{{ asset('images/png/030-bank.png') }}" style="height: 64px!important;width: 64px!important;" alt="Image pago" width="100%" height="100%">
										</i>
