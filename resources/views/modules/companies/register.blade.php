                ...
                <form action="#" method="post" class="card" enctype="multipart/form-data" id="company-register">
                    ...
                    <div class="card-content row">
                        ...
                        <div class="input-field col s12 m4">
                            ...
                            <input type="text" name="code_catastral" id="code_catastral" class="validate code-only" pattern="[0-9A-Z]+" minlength="15" maxlength="45" title="Solo puede usar números y letras en mayúsculas." required>
                        ...
                        <div class="input-field col s12 m6">
                            ...
                            <input type="text" name="code" id="code" maxlength="6" class="validate number-only" value="" pattern="[0-9]+">
