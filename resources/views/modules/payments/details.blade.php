                ...
                <div class="col s12 m10 offset-m1">
                    <form action="" method="post" class="card" id="register">
                        ...
                        <div class="input-field col s4 m3">
                            ...
                            <input type="hidden" value="{{$payments->taxes->id}}" id="taxes_id">
                            ...
                            <select name="document_type" id="document_type" disabled>
                                ...
                                <option value="J" @if ($payments->taxes->companies[0]->typeDocument=='J'){{"selected"}}@endif>J</option>
                                <option value="V" @if ($payments->taxes->companies[0]->typeDocument=='V'){{"selected"}}@endif>V</option>
                                <option value="G" @if ($payments->taxes->companies[0]->typeDocument=='G'){{"selected"}}@endif>G</option>
                                <option value="E" @if ($payments->taxes->companies[0]->typeDocument=='E'){{"selected"}}@endif>E</option>
                            </select>
                        ...
                        <div class="input-field col s8 m3 tooltipped" data-position="bottom" data-tooltip="EL RIF solo debe contener número sin - ni caracteres extraños. Ej: 1234567890">
                            <input type="text" name="RIF" id="RIF" value="{{$payments->taxes->companies[0]->document}}" class="validate number-only" pattern="[0-9]+" maxlength="10" minlength="6" title="Solo puede escribir números." required readonly>
                        ...
                        <div class="input-field col s12 m6 tooltipped" data-position="bottom" data-tooltip="Razón social o nombre de la empresa.">
                            ...
                            <input type="text" name="name" id="name" class="validate"  pattern="[0-9A-Za-zàáâäãèéêëìíîïòóôöõùúûüñçÀÁÂÄÃÈÉÊËÌÍÎÏÒÓÔÖÕÙÚÛÜÑßÇ .,!?_-&%+-$]+" title="Solo puede usar letras (con acentos), números y los caracteres especiales: . , $ ! ? % + -" value="{{$payments->taxes->companies[0]->name }}" required readonly>
                        ...
                        <div class="input-field col s12 m6 tooltipped" data-position="bottom" data-tooltip="Solo puede usar números y letras en mayúsculas. Ej: A1B2C3">
                            ...
                            <input type="text" name="license" id="license" class="validate" pattern="[0-9A-Z]+" title="Solo puede usar números y letras en mayúsculas." value="{{  $payments->taxes->companies[0]->license}}" required readonly>
                            ...
                            <div class="input-field col s6">
                                ...
                                <input type="text" name="fiscal_period_view" id="fiscal_period_view"
                                       value="{{\App\Helpers\TaxesMonth::convertFiscalPeriod($payments->taxes->fiscal_period)}}" readonly>
                            ...
                            <div class="input-field col s6">
                                ...
                                <input type="text" name="code" id="code"
                                       value="{{$payments->taxes->code}}" readonly>
                            ...
                            <div class="input-field col m6 s12">
                                <i class="icon-satellite prefix"></i>
                                <input type="text" name="bank_destinations" id="bank_destinations" value="{{$payments->taxes->bankName}}" class="validate" required>
                                <label>Destino</label>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col s12 center-align " >
                                <h4 class="center-align" style="border:1px dotted #f0ad4e;">Estado: {{$payments->taxes->statusName}}.</h4>
                            </div>
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                ...
                                <a href="{{url('payments/taxes/'.$payments->taxes->id)}}"  class="btn btn-rounded col s4 blue waves-effect waves-light">
