        ...
        <div class="row">
            <div class="col s12">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{url('ticketOffice/vehicle/details/'.$vehicle->id)}}">Detalles</a></li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <table class="centered highlight" id="history" style="width: 100%">
                                ...
                                <tbody>
                                @foreach($vehicle->taxesVehicle()->get() as $taxe)
                                    <tr>
                                        ...
                                        @can('Detalles Planilla')
                                            ...
                                            @if($taxe->branch==='Pat.Veh')

                                                <td>
                                                    <a href="{{url('ticketOffice/vehicle/viewDetails',['id'=>$taxe->id])}}"
