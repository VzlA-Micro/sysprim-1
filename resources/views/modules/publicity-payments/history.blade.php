        ...
        <div class="row">
            <div class="col s12">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('properties.payments.history', ['id' => $publicity->id]) }}">Historial de Pagos</a></li>
                </ul>
            </div>
                                        ...
                                        <tr>
                                            ...
                                            @if($taxe->status==='process')
                                                ...
                                                @can('Descargar Mi Planilla')
                                                    <td><a href="{{ route('publicity.taxpayers.pdf', ['id' => $taxe->id]) }}"
                                            ...
                                            @elseif($taxe->status==='verified' || $taxe->status=='verified-sysprim'|| $taxe->status=='exempt' )
                                                ...
                                                @can('Descargar Mi Planilla')
                                                    <td>
                                                        <a href="{{ route('publicity.taxpayers.pdf', ['id' => $taxe->id]) }}" class="btn orange waves-effect waves-light"><i class="icon-description left">
