        ...
        <div class="row">
            <div class="col s12">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('properties.details', ['id' => $property->id]) }}">{{ $property->alias }}</a></li>
                                    ...
                                    @if($taxe->status=='verified' || $taxe->status=='verified-sysprim' || $taxe->status=='exempt'   || $taxe->status=='process'&&$taxe->created_at->format('d-m-Y')==\Carbon\Carbon::now()->format('d-m-Y')||$taxe->status=='cancel')
                                        ...
                                        <tr>
                                            ...
                                            @elseif($taxe->status==='verified' || $taxe->status=='verified-sysprim'  ||   $taxe->status=='exempt')
                                                ...
                                                @can('Descargar Mi Planilla')
                                                <td>
                                                    <a href="{{ route('properties.taxpayers.pdf', ['id' => $taxe->id]) }}" class="btn orange waves-effect waves-light">
                                                        <span class="truncate">
